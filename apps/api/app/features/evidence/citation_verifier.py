"""Citation quality checks shared by evidence-grounded generated artifacts."""
...
def citation_has_retrieved_id(
    citation: Citation,
    valid_by_chunk: dict[uuid.UUID, Any],
    valid_by_source: dict[uuid.UUID, Any],
) -> bool:
    """Return whether a citation points at one of the retrieved source/chunk IDs."""
...
def dedupe_citations(citations: list[Citation]) -> list[Citation]:
    """Keep the first citation for each source/chunk pair."""
